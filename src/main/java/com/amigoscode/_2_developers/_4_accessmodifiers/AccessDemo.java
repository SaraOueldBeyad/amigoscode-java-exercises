...
public class AccessDemo {
    ...
    public static void main(String[] args) {
        ...
        accessModifiers.setSecret("Secret");
        ...
        /*It won't work because the attribute is private which means that it is accessible only in the same class
        and the access it we need to use the getters and setters
         */
