...
public class MethodOverloading {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("2 + 3 = " + add(1, 2, 3));
        System.out.println("2 + 3 = " + add(1.5, 2.5));
        System.out.println("Hello wrapped in brackets: " + format("hello"));
        System.out.println("42 with leading zeros: " + format(42));
